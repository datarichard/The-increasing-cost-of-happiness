...
```{r get_posteriors}
income_summary <- read_rds("../results/gh9_hhoecd_data.RDS")
...
Supplementary information is available [online](https://datarichard.github.io/The-increasing-cost-of-happiness/supplementary.html){target="_blank"}.  

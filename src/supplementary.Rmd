...
##### Figure S3. Cubic spline of household wealth on satisfaction and happiness
```{r losat_gh9_hwnwip}
...
##### Figure S5. Posterior predictive distribution of marginal effect of wealth by year (95% CI)  
(not run)


```{r figure_s2, fig.height = 3, eval=F}
library(brms)

...
lm_fit <- readRDS("../results/no_topcodes/fit_lm_hifdip_losat_cov_2002.RDS")
pw_fit <- readRDS("../results/no_topcodes/fit_nl_hifdip_losat_cov_2002.RDS")
...
for (i in c(2001:2018)) {
  ...
  lm_fit <- readRDS(paste0("../results/no_topcodes/fit_lm_hifdip_losat_cov_", i, ".RDS"))
  pw_fit <- readRDS(paste0("../results/no_topcodes/fit_nl_hifdip_losat_cov_", i, ".RDS"))

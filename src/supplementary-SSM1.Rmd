...
```
```
Figure legend: Comparison of the conditional parameter estimates (red) and unconditional parameter estimates (grey) in the piecewise-linear model of income on happiness. The conditional models included covariates for age, age squared, sex, education, and illness. Horizontal bar represents the 95% credible region and the solid point indicates the expected value (median) of each distribution.
```  
...
```{r figure_s4, fig.width=6, fig.height = 6, dpi=300}
...
```{r figure_s5, fig.height=9, fig.width=9, dpi=600}

...
**keywords:** Subjective wellbeing, wealth, household income, HILDA  
...
predicted_fits %>%
  ...
  labs(caption = "Source:     HILDA, University of Melbourne
                 Predicted happiness scores (SD units) from piecewise regression on real household income", 
       x = "", y = "") -> p

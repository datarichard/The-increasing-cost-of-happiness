...
lm_fits = read_rds(
  paste0(here, "results/fits/excl_topcodes/sd/lm_gh9_hhoecd_0cov.RDS")
)

nl_fits = read_rds(
  paste0(here, "results/fits/excl_topcodes/sd/gh9_hhoecd_0cov_tight.RDS")
)
...
nl_fits_losat = read_rds(
  paste0(here, "results/fits/excl_topcodes/sd/losat_hhoecd_0cov.RDS")
)

lm_fits_losat = read_rds(
  paste0(here, "results/fits/excl_topcodes/sd/lm_losat_hhoecd_0cov.RDS")
)
...
nl_fits = read_rds(
  paste0(here, "results/fits/excl_topcodes/sd/exc_zeros/gh9_hhoecd_0cov_tight.RDS")
)

log_fits = read_rds(
  paste0(here, "results/fits/excl_topcodes/sd/log_gh9_hhoecd_0cov.RDS")
)
...
bind_rows(income_summary, .id = "fit") %>%
